...
print("Command: ", args_command)
print("Model: ", args_model)
print("Dataset: ", args_dataset)
print("Year: ", args_year)
print("Logs: ", args_logs)
print("Auto Download: ", args_download)
...
if args_model.lower() == "coco":
    model_path = COCO_MODEL_PATH
elif args_model.lower() == "last":
    # Find last trained weights
    model_path = model.find_last()
elif args_model.lower() == "imagenet":
...
if args_command == "train":
    ...
    dataset_train.load_coco(args_dataset, "train", year=args_year, auto_download=args_download)
    # if args_year in '2014':
    #     dataset_train.load_coco(args_dataset, "train", year=args_year, auto_download=args_download)
    ...
    dataset_val.load_coco(args_dataset, "val", year=args_year, auto_download=args_download)
    dataset_val.prepare()
    ...
    print("'{}' is not recognized. "
          "Use 'train' or 'evaluate'".format(args_command))
